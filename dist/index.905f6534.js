...
var _kaboom = require("../kaboom");
var _kaboomDefault = parcelHelpers.interopDefault(_kaboom);
const { pos , sprite , origin , keyIsDown , scale , width , height  } = _kaboomDefault.default;
function CharacterMovement() {
    ...
    faune.action(()=>{
        ...
        if (left) {
            if (curAnim !== 'walk-side') faune.play('walk-side');
            faune.flipX(true);
            faune.pos.x -= speed;
        } else if (up) {
            if (curAnim !== 'walk-up') faune.play('walk-up');
            faune.pos.y -= speed;
        } else if (down) {
            if (curAnim !== 'walk-down') faune.play('walk-down');
            faune.pos.y += speed;
        } else if (right) {
            if (curAnim !== 'walk-side') faune.play('walk-side');
            faune.flipX(false);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../kaboom":"h3uqb"}],"h3uqb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var rr = Object.defineProperty, Hi = Object.defineProperties;
...
, P = (i, t)=>{
    ...
    if (ir) for (var l of ir(t))Qi.call(t, l) && Nt(i, l, t[l]);
    return i;
}, D = (i, t)=>Hi(i, zi(t))
;
var a = (i, t)=>rr(i, "name", {
...
a(E, "rgb");
var dr = a((i, t, l)=>v.fromHSL(i, t, l)
, "hsl2rgb"), k = class {
    constructor(t, l, w, U){
        b(this, "x", 0);
        b(this, "y", 0);
...
a(Xt, "wave");
var Zi = 1103515245, es = 12345, pr = 2147483648, be = class {
    constructor(t){
        b(this, "seed");
        this.seed = t;
    }
    gen(...t) {
        if (t.length === 0) return this.seed = (Zi * this.seed + es) % pr, this.seed / pr;
        if (t.length === 1) {
...
a(le, "testLineLine");
function dt(i, t) {
    return ae(i, t.p1) || ae(i, t.p2) ? !0 : !!le(t, new he(i.p1, f(i.p2.x, i.p1.y))) || !!le(t, new he(f(i.p2.x, i.p1.y), i.p2)) || !!le(t, new he(i.p2, f(i.p1.x, i.p2.y))) || !!le(t, new he(f(i.p1.x, i.p2.y), i.p1));
}
a(dt, "testRectLine");
function ae(i, t) {
